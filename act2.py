...
print(f"{num} es {par_o_impar(num)}\n")
...
print(f"La suma del 1 a {n} es {suma_de_numeros(n)}\n")
...
print(f"Tu palabra/frase {palabra} {palindromo(formatted_word)}\n")
